...
def enrollment(reason):
    ...
    def pkcs10enroll(InputCsrFile, caHost, trustChainFile, clientCrt, clientKey, certProfile, eeProfile, caName, userName):
        ...
        output_cert = "clientcert.pem"
        out_file = open(output_cert, "w")
        out_file.write(pem)
        out_file.close()

    key_file='client-02.key'
    csr_file='../client-02.csr'
    config_file='../client-02.conf'
    ...
    certProfile = 'TLS Client Profile'
    eeProfile = 'TLS Client Profile'
